using Base: UUID
using CompilePreferences, Test, TOML, Pkg
...
@testset "CompilePreferences" begin
    ...
    with_temp_project() do project_dir
        ...
        save_preferences!(up_uuid, Dict("foo" => "bar"))
        ...
        @test prefs == load_preferences(up_uuid)
    ...
    mktempdir() do outer_env
        ...
        activate(outer_env) do
            save_preferences!(up_uuid, Dict("foo" => "outer"))
        end
        ...
        try
            ...
            with_temp_project() do project_dir
                save_preferences!(up_uuid, Dict("foo" => "inner"))
